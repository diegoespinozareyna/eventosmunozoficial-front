                        ...
                        <TransformComponent>
                            ...
                            >
                                ...
                                <svg
                                    ...
                                    className="h-[70vh] md:h-[100vh] w-[100%] md:w-[70%] scale-[1.1] md:scale-[1]"
                                    ...
                                    <g>
                                        ...
                                        >
                                            <path
                                                ...
                                                onClick={(event: any) => {
                                                    setOpen(true);
                                                    handleClickInformation(event.target.id, false);
                                                }}
                                        ...
                                        <g
                                            ...
                                            transform="matrix(0.45,0,0,0.45,-75,21)"
                                        >
                                            <text
                                                style={{
                                                    fontSize: "18px",
                                        ...
                                        <g id="corchetesvip" transform="matrix(3,0,0,1.5,7,-10)">
                                            <rect
                                                style={{ fill: "#fff" }}
                                                id="rect2"
                                                width="0.59204644"
                                        ...
                                        <g
                                            id="corchetesgeneral"
                                            transform="matrix(3,0,0,1.7,7,-32)"
                                        >
                                            <rect
                                                style={{ fill: "#fff" }}
                                                id="rect2-2-3"
                                        ...
                                        <g
                                            id="corchetesgeneral"
                                            transform="matrix(1.5,0,0,1.7,30,-32)"
                                        >
                                            <text
                                                // xml:space="preserve"
                                            ...
                                            >
                                                ...
                                                <tspan x="11.392578" y="376.64914" id="tspan2">
                                                    I
                                                </tspan>
